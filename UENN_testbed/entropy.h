...
/// <returns></returns>
torch::Tensor shannon_entropy(torch::Tensor belief, float epsilon = 1e-20) {
...
/// <param name="belief"></param>
/// <returns></returns>
torch::Tensor total_disagreement(torch::Tensor belief) {
...
/// <returns></returns>
torch::Tensor max_entropy(int num_classes) {
...
/// <param name="belief"></param>
/// <returns></returns>
torch::Tensor hartley_entropy(torch::Tensor belief) {
...
/// <param name="belief"></param>
/// <returns></returns>
torch::Tensor hull_entropy(torch::Tensor belief) {
...
/// <param name="belief"></param>
/// <returns></returns>
torch::Tensor distance_based_entropy(torch::Tensor belief) {
	// Compute pairwise distances between belief functions
	torch::Tensor diff = belief.unsqueeze(1) - belief.unsqueeze(2);
	torch::Tensor distances = torch::norm(diff, /*p=*/2, /*dim=*/-1);
...
/// <returns></returns>
torch::Tensor robustness_entropy(torch::Tensor belief, float epsilon = 1e-20) {
	// Add a small epsilon value to handle zero beliefs
	belief = belief.clamp_min(epsilon);
...
/// <param name="belief"></param>
/// <returns></returns>
torch::Tensor consistency_entropy(torch::Tensor belief, float epsilon = 1e-20) {
...
/// <returns></returns>
torch::Tensor information_gain(torch::Tensor belief, torch::Tensor true_labels, float epsilon = 1e-20) {
